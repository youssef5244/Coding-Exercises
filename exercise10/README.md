...
Therefore, your task is to conditionally show a warning box once a user has
...
The second button, outside of the <div> with the id="alert", should show the
<div id="alert"> (and all its content).
...
Important: In this Udemy code editor you may get an error if you use useState() -
